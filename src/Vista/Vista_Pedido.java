...
public class Vista_Pedido extends javax.swing.JInternalFrame {
    ...
    public void setDlgped(JDialog dlgped) {
        this.dlgped = dlgped;
    }
    ...
    public JDateChooser getJdcfech() {
        return jdcfech;
    }

    public void setJdcfech(JDateChooser jdcfech) {
        this.jdcfech = jdcfech;
    }
    ...
    public JTable getTblped() {
        return tblped;
    }

    public void setTblped(JTable tblped) {
        this.tblped = tblped;
    }
    ...
    public void setTxtcoped(JTextField txtcoped) {
        this.txtcoped = txtcoped;
    }
    ...
    private void initComponents() {
        ...
        dlgped = new javax.swing.JDialog();
        ...
        dlgped.getContentPane().setLayout(dlgpedLayout);
        ...
        jLabel7.setText("Datos generales de pedido");
